		...
		<div class="container">
			<div class="row">
				...
				<div class="span9">
					...
					<h3>
						Products Compairsition <small class="pull-right"> 2
							products are compaired </small>
					</h3>
					<hr class="soft" />
							...
							<tr>
								...
								<td style="text-align: center">
									<p class="justify">Nowadays the lingerie industry is one of
										...
										so popular and we have a great number of faithful customers
										all over the country.</p> <img src="themes/images/products/1.jpg"
									alt="" />
								...
								<td>
									<p class="justify">Nowadays the lingerie industry is one of
										...
										with the latest fashion tendencies - that is why our goods are
										so popular and we have a great number of faithful customers
										all over the country.</p> <img src="themes/images/products/3.jpg"
									alt="" />
